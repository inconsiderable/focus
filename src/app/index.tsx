...
const App: React.FC = () => {
  ...
  const appState = {
    ...
    selectedNode,
    setSelectedNode: (n: string) => {
      // window.localStorage.removeItem('space-time-store');
      // window.localStorage.removeItem('ps-current-view');
      // window.localStorage.removeItem('ps-genesis-view');
      setSelectedNode(n);
    },
    colorScheme,
  };
          ...
          <IonTabs>
            ...
            <IonTabBar id="app-tab-bar" slot="bottom">
              ...
              <IonTabButton tab="point" href="/point">
                <IonIcon aria-hidden="true" icon={chevronCollapseOutline} />
              </IonTabButton>
